report 50031 "Purchase - Invoice ERPG"
{
    DefaultLayout = RDLC;
    //RDLCLayout = './PurchaseInvoice.rdlc';
    RDLCLayout = './Layouts/PurchaseInvoice ERPG.rdl';
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    //HBK / ERPG - 230922//
                    column(VendorInvNoCaption; VendorInvNoCaption)
                    {
                    }
    ...
    var
        ...
        VendorInvNoCaption: TextConst DAN = 'Ext. Fak.', DEU = 'Ext. Rechnung', ENU = 'Ext. Invoice';  //HBK / ERPG - 220922
